...
Probably the most natural measure of performance would be to look at the average difference between pick number and rank, accross all rounds, organized by Drafter. We can calculate this using `aggregate`.
...
# Order dataframe by worst draft to best
posDiffs <- posDiffs[order(posDiffs$RankDiff, decreasing = TRUE),]
